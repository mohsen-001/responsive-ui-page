...
const Caption = () => {
  return (
    <div className="absolute top-2/4 start-24 -translate-y-2/4 text-black max-md:start-16 max-[520px]:!start-10">
      <motion.div
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        className="capitalize text-7xl leading-[1.2] font-bold mb-8 max-xl:text-6xl max-md:text-5xl max-[520px]:!text-4xl"
      >
